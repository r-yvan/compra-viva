  ...
  return (
    <div className="text-white flex flex-row bg-[#151515] rounded-xl p-4 gap-5">
      <div className="flex flex-col gap-3 w-1/2">
        <div className="px-3 py-1 bg-[#202020] w-fit rounded-full">Sellers</div>
        <div className="flex flex-col gap-2">
          <p className="text-3xl tracking-tighter">Join other sellers</p>
          <p className="opacity-50">
            There is a large community of sellers out there using CompraViva and
