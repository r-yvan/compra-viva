  ...
  return (
    <div className="flex flex-col bg-[#050505] gap-5 p-2 w-full h-screen">
      ...
      <div className="grid grid-cols-12 grid-rows-12 gap-2 h-full">
        <div className="col-span-4 row-span-3 bg-[#0a0a0a] rounded-lg border border-white border-opacity-10">
        ...
        <div className="col-span-4 row-span-6 bg-[rgb(10,10,10)] rounded-lg border border-white border-opacity-10">
          <div className="flex justify-center pt-3 gap-2">
            <IconHistory size={30} />
        ...
        <div className="col-span-8 row-span-9 bg-[#0a0a0a] rounded-lg border border-white border-opacity-10">
          <div className="flex justify-center pt-3 gap-2">
